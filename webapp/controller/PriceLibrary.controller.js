    ...
    return Controller.extend("myapp.controller.PriceLibrary", {
        ...
        _buildDialogData: function (sMode, oRecord, sPath) {
            return {
                ...
                taxRate: oRecord ? String(oRecord.taxRate) : "13",
                ...
                content: [
                    ...
                    new Select({
                        ...
                        items: {
                            ...
                            template: new Item({ key: "{suppliers>id}", text: "{suppliers>name}" })
                        }
                    }),
                    ...
                    new Select({
                        ...
                        items: {
                            ...
                            template: new Item({ key: "{materials>id}", text: "{materials>name}" })
                        }
                    }),
        ...
        _onSaveDialog: function () {
            ...
            if (!oSupplier || !oMaterial || !oData.validFrom || !oData.validTo || !iUnitPrice) {
                MessageToast.show("请完整填写供应商、物料、有效期和价格");
                return;
            }

            if (Date.parse(oData.validFrom) > Date.parse(oData.validTo)) {
                MessageToast.show("失效日期不能早于生效日期");
                return;
            }
